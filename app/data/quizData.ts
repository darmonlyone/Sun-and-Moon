...
export const results: Record<ResultKey, ResultProfile> = {
  newMoon: {
    ...
    meaningEn: 'The phase of new beginnings, hidden seeds, and private dreams.',
    meaningTh: 'ช่วงเวลาแห่งการเริ่มต้นใหม่ เมล็ดฝันที่ซ่อนอยู่ และความตั้งใจเงียบ ๆ',
    personalityEn:
  ...
  fullMoon: {
    ...
    meaningEn: 'A symbol of illumination, completion, and emotional clarity.',
    meaningTh: 'สัญลักษณ์ของความสว่าง การเติมเต็ม และความชัดเจนทางอารมณ์',
    personalityEn:
  ...
  supermoon: {
    titleEn: 'Supermoon',
    titleTh: 'ซูเปอร์มูน',
    meaningEn: 'The moon at its closest and brightest appearance from Earth.',
    meaningTh: 'ช่วงที่ดวงจันทร์อยู่ใกล้โลกและสว่างโดดเด่นเป็นพิเศษ',
    personalityEn:
  ...
  micromoon: {
    titleEn: 'Micromoon',
    titleTh: 'ไมโครมูน',
    meaningEn: 'The moon when it appears smaller and more distant.',
    meaningTh: 'ช่วงที่ดวงจันทร์ดูเล็กลงและอยู่ไกลจากโลก',
    personalityEn:
  ...
  blueMoon: {
    titleEn: 'Blue Moon',
    titleTh: 'บลูมูน',
    meaningEn: 'A rare moon event associated with uniqueness and surprise.',
    meaningTh: 'ปรากฏการณ์จันทร์หายากที่สื่อถึงความไม่เหมือนใครและความน่าประหลาดใจ',
    personalityEn:
  ...
  bloodMoon: {
    ...
    meaningEn: 'A dramatic red moon during a total lunar eclipse.',
    meaningTh: 'ดวงจันทร์สีแดงเข้มอันโดดเด่นระหว่างจันทรุปราคาเต็มดวง',
    personalityEn:
  ...
  harvestMoon: {
    ...
    meaningEn: 'A moon connected to abundance, gratitude, and celebration.',
    meaningTh: 'ดวงจันทร์ที่เชื่อมโยงกับความอุดมสมบูรณ์ ความขอบคุณ และการเฉลิมฉลอง',
    personalityEn:
  ...
  lunarEclipse: {
    ...
    titleTh: 'จันทรุปราคา',
    meaningEn: 'A moment when the Earth’s shadow reveals new emotional truths.',
    meaningTh: 'ช่วงเวลาที่เงาโลกเผยให้เห็นความจริงใหม่ ๆ ทางอารมณ์',
    personalityEn:
  ...
  sunrise: {
    ...
    meaningEn: 'The beginning light of hope, renewal, and momentum.',
    meaningTh: 'แสงแรกแห่งความหวัง การเริ่มต้นใหม่ และพลังในการก้าวต่อ',
    personalityEn:
  ...
  solarNoon: {
    ...
    meaningEn: 'The sun at its highest point, symbolizing precision and clarity.',
    meaningTh: 'ช่วงที่ดวงอาทิตย์อยู่สูงสุด สื่อถึงความชัดเจนและแม่นยำ',
    personalityEn:
  ...
  sunset: {
    ...
    meaningEn: 'A time of reflection, romance, and gentle closure.',
    meaningTh: 'ช่วงเวลาแห่งการทบทวน ความโรแมนติก และการปิดวันอย่างอ่อนโยน',
    personalityEn:
  ...
  sunspot: {
    ...
    meaningEn: 'Dark spots that reveal the sun’s dynamic magnetic activity.',
    meaningTh: 'จุดมืดที่แสดงพลังการเปลี่ยนแปลงทางแม่เหล็กของดวงอาทิตย์',
    personalityEn:
  ...
  solarEclipse: {
    ...
    titleTh: 'สุริยุปราคา',
    meaningEn: 'A rare alignment where shadow and light create awe.',
    meaningTh: 'ปรากฏการณ์หายากที่เงาและแสงมาเรียงตัวกันอย่างน่าทึ่ง',
    personalityEn:
...
export const midwayQuote = {
  en: 'They are choosing you, or you are choosing them?',
